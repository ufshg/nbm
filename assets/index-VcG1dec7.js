      ...
      e: for (var Q = 0, Z = C.length, pr = Z >>> 1; Q < pr; ) {
        ...
        if (0 > l($l, O))
          Ct < Z && 0 > l(hr, $l)
            ? ((C[Q] = hr), (C[Ct] = O), (Q = Ct))
            : ((C[Q] = $l), (C[xt] = O), (Q = xt));
        else if (Ct < Z && 0 > l(hr, O)) (C[Q] = hr), (C[Ct] = O), (Q = Ct);
        else break e;
      }
    }
    return T;
...
function nd(e, t, n, r, l, o, i, u, s) {
  (Dn = !1), (Yr = null), ed.apply(td, arguments);
}
function rd(e, t, n, r, l, o, i, u, s) {
  if ((nd.apply(this, arguments), Dn)) {
    if (Dn) {
      var a = Yr;
      (Dn = !1), (Yr = null);
...
var Ae = Math.clz32 ? Math.clz32 : dd,
  cd = Math.log,
  fd = Math.LN2;
function dd(e) {
...
function Li(e, t, n, r) {
  if (Zr) {
    ...
    else if ((Lu(e, r), t & 4 && -1 < yd.indexOf(e))) {
      for (; l !== null; ) {
        var o = ar(l);
        if (
          (o !== null && Ca(o),
...
var br = null;
function Io(e, t, n, r) {
  if (((br = null), (e = Ni(r)), (e = Rt(e)), e !== null))
  ...
  Sl = H({}, sr, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== Cn &&
            (Cn && e.type === "mousemove"
              ? ((Yl = e.screenX - Cn.screenX), (Jl = e.screenY - Cn.screenY))
              : (Jl = Yl = 0),
            (Cn = e)),
          Yl);
    },
...
function $u() {
  jn && (jn.detachEvent("onpropertychange", ja), (Yn = jn = null));
}
function ja(e) {
  if (e.propertyName === "value" && El(Yn)) {
    var t = [];
    Da(t, Yn, e, Ni(e)), ma(Yd, t);
  }
}
function Gd(e, t, n) {
  e === "focusin"
    ? ($u(), (jn = t), (Yn = n), jn.attachEvent("onpropertychange", ja))
    : e === "focusout" && $u();
}
function qd(e) {
...
var Ba = kl("animationend"),
  $a = kl("animationiteration"),
  Ha = kl("animationstart"),
  Va = kl("transitionend"),
  Wa = new Map(),
  Qu =
...
for (var eo = 0; eo < Qu.length; eo++) {
  var to = Qu[eo],
    rp = to.toLowerCase(),
    lp = to[0].toUpperCase() + to.slice(1);
  St(rp, "on" + lp);
}
  ...
  if (!e[Cr]) {
    (e[Cr] = !0),
      bs.forEach(function (n) {
        n !== "selectionchange" && (op.has(n) || no(n, !1, e), no(n, !0, e));
      });
  ...
  ma(function () {
    ...
    if (!(t & 7)) {
      ...
      if (Ai)
        ...
        Vt
          ? za(e, n) && (N = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (N = "onCompositionStart");
      N &&
        (La &&
          n.locale !== "ko" &&
          (Vt || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && Vt && (P = Oa())
            : ((st = h),
...
var Wo = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  ap =
    typeof queueMicrotask == "function"
      ...
      : typeof Ju < "u"
      ? function (e) {
          return Ju.resolve(null).then(e).catch(cp);
        }
      : Wo;
function cp(e) {
  setTimeout(function () {
...
function kt() {
  if (!oo && Ke !== null) {
    ...
    try {
      ...
      throw (Ke !== null && (Ke = Ke.slice(e + 1)), wa(Ri, kt), l);
    } finally {
      (A = t), (oo = !1);
    }
  }
...
function Ii(e) {
  for (; e === ll; )
    (ll = Yt[--Jt]), (Yt[Jt] = null), (ol = Yt[--Jt]), (Yt[Jt] = null);
  for (; e === Dt; )
    (Dt = xe[--Ce]),
      (xe[Ce] = null),
      (Ye = xe[--Ce]),
...
function nc(e) {
  ...
  function y(d, c, p, w) {
    for (
      var x = null, _ = null, P = c, N = (c = 0), W = null;
      P !== null && N < p.length;
      N++
    ) {
    ...
    if (N === p.length) return n(d, P), U && _t(d, N), x;
    if (P === null) {
      for (; N < p.length; N++)
        (P = f(d, p[N], w)),
          P !== null &&
  ...
  function v(d, c, p, w) {
    ...
    for (
      var _ = (x = null), P = c, N = (c = 0), W = null, z = p.next();
      P !== null && !z.done;
      N++, z = p.next()
    ) {
      P.index > N ? ((W = P), (P = null)) : (W = P.sibling);
      var Oe = m(d, P, z.value, w);
      if (Oe === null) {
        P === null && (P = W);
        break;
      }
    ...
    if (z.done) return n(d, P), U && _t(d, N), x;
    if (P === null) {
...
function wc(e, t, n) {
  return At & 21
    ? (Me(n, t) || ((n = ka()), ($.lanes |= n), (jt |= n), (e.baseState = !0)),
      t)
...
function Ac(e) {
  ...
  t !== null && ((e.alternate = null), Ac(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Be], delete t[Zn], delete t[Qo], delete t[fp], delete t[dp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function je(e, t, n, r) {
  ...
  ur(e, n, r),
    (!(D & 2) || e !== ee) &&
      ...
      ye(e, r),
      n === 1 && D === 0 && !(t.mode & 1) && ((dn = K() + 500), Cl && kt()));
}
function ye(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Ou(n), t === 1))
      e.tag === 0 ? pp(ks.bind(null, e)) : Ya(ks.bind(null, e)),
        ap(function () {
          !(D & 6) && kt();
        }),
        (n = null);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = Wo(Pt.bind(null, e, de, Qe), t);
            break;
          }
          Pt(e, de, Qe);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Wo(Pt.bind(null, e, de, Qe), r);
            break;
          }
          Pt(e, de, Qe);
          break;
...
function Mt(e) {
  ...
  try {
    ...
    (A = r), (Pe.transition = n), (D = t), !(D & 6) && kt();
  }
}
function lu() {
  (ve = Zt.current), I(Zt);
...
function ml(e, t) {
  ...
  while (!0);
  if (($i(), (D = n), (dl.current = r), Y !== null)) throw Error(S(261));
...
function Pt(e, t, n) {
  var r = A,
    l = Pe.transition;
  try {
    (Pe.transition = null), (A = 1), Ap(e, t, n, r);
  } finally {
    (Pe.transition = l), (A = r);
  }
  return null;
...
function jp(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    ee === e &&
      (ne & n) === n &&
      (q === 4 || (q === 3 && (ne & 130023424) === ne && 500 > K() - nu)
        ? Lt(e, 0)
        : (tu |= n)),
    ye(e, t);
}
...
Kc = function (e, t, n) {
  ...
  else (pe = !1), U && t.flags & 1048576 && Ja(t, ol, t.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Ti(t, n | 1), ye(t, K()), !(D & 6) && ((dn = K() + 500), kt()));
      }
      break;
    case 13:
      Mt(function () {
...
pa = ru;
ha = Mt;
var Qp = { usingClientEntryPoint: !1, Events: [ar, Kt, xl, fa, da, ru] },
  Nn = {
...
const uh = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  Rs = "0123456789",
  of = { DIGIT: Rs, ALPHA: mo, ALPHA_DIGIT: mo + mo.toUpperCase() + Rs },
...
const _h = (e) => {
  ...
  Ph = We("AsyncFunction"),
  Nh = (e) => e && (jl(e) || Ne(e)) && Ne(e.then) && Ne(e.catch),
  g = {
    isArray: vn,
    isArrayBuffer: bc,
    isBuffer: Jp,
...
const Ls = zh,
  ...
  Fh = typeof URLSearchParams < "u" ? URLSearchParams : du,
  Dh = typeof FormData < "u" ? FormData : null,
  Ah = typeof Blob < "u" ? Blob : null,
  jh = {
    isBrowser: !0,
    classes: { URLSearchParams: Fh, FormData: Dh, Blob: Ah },
    protocols: ["http", "https", "file", "blob", "url", "data"],
  },
  pf = typeof window < "u" && typeof document < "u",
  Mh = ((e) => pf && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(
  ...
  vf = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !om(n) && ((r = hi[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
const mi = { assertOptions: im, validators: mu },
  rt = mi.validators;
class vl {
  constructor(t) {
    (this.defaults = t),
...
J.mergeConfig = pn;
J.AxiosHeaders = Ge;
J.formToJSON = (e) => hf(g.isHTMLForm(e) ? new FormData(e) : e);
J.getAdapter = vf.getAdapter;
J.HttpStatusCode = cm;
J.default = J;
const Is = J;
...
function dm() {
  ...
  Nt.useState(""), Nt.useState([]);
  const n = "https://open.api.nexon.com/maplestory",
    r = fm.VITE_KEY,
    l = (s) => {
      t(s.target.value);
    };
  async function o(s) {
    try {
      const a = await Is.get(n + "/v1/id?character_name=" + s, {
        headers: { "x-nxopen-api-key": r },
      });
      let h = new Date(),
        f = h.getFullYear(),
        m = ("0" + (h.getMonth() + 1)).slice(-2),
        E = ("0" + h.getDate()).slice(-2),
        y = f + "-" + m + "-" + E,
        R = await (
          await Is.get(
            n + "/v1/ranking/union?date=" + y + "&ocid=" + a.data.ocid,
            { headers: { "x-nxopen-api-key": r } }
          )
        ).data.ranking,
        d = "";
      for (let c = 0; c < R.length; c++)
        (d +=
          ...
          "  Lv." +
          R[c].union_level),
          c != R.length - 1 && (d += "<br><br>");
      document.getElementById("result").innerHTML = d;
    } catch (a) {
      (document.getElementById("result").innerHTML = "찾을 수가 없어요."),
        console.error(a);
    }
  }
  const i = (s) => {
  ...
  return X.jsxs(X.Fragment, {
    children: [
      X.jsx("h1", { children: "너 본캐 뭐냐??" }),
      X.jsx("h2", { children: "누구세요??" }),
      X.jsx("hr", {}),
      X.jsx("p", { children: "* 검색이 안되면 나중에 다시 해보기 *" }),
      X.jsx("p", { children: "** 고로시용 아님 **" }),
      X.jsx("hr", {}),
      X.jsx("p", {
        children: "유니온 기준 가장 높은 레벨의 캐릭터가 나옵니다",
      }),
      X.jsx("p", {
        children: "안나오면 최근 접속기록이 없는 캐릭터일 가능성이 있음",
      }),
      X.jsx("p", { children: "제작자인 제가 어찌 할 영역이 아닌듯" }),
      X.jsx("p", {
        children: "0.2v 업데이트 - 모든 월드의 대표캐릭터를 가져옵니다",
      }),
      X.jsx("p", {
        children:
          "0.3v 업데이트 - 닉네임을 눌러 멮지지로 바로 이동하기 기능 추가",
      }),
      X.jsxs("div", {
        className: "card",
        children: [
          ...
          X.jsx("button", { onClick: u, children: "검색" }),
        ],
      }),
      X.jsx("div", { id: "result", children: X.jsx("p", {}) }),
    ],
  });
}
wo.createRoot(document.getElementById("root")).render(
  X.jsx(Mf.StrictMode, { children: X.jsx(dm, {}) })
);
